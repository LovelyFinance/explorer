defmodule BlockScoutWeb.Etherscan do
  ...
  @token_model %{
    ...
    fields: %{
      ...
      type: %{
        type: "token type",
        enum: ~s(["INU-20", "INU-721"]),
        enum_interpretation: %{"INU-20" => "INU-20 token standard", "INU-721" => "INU-721 token standard"}
      },
      cataloged: %{
        type: "boolean",
  ...
  @token_gettoken_action %{
    name: "getToken",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>INU-20</a> " <>
        "or <a href='https://github.com/ethereum/EIPs/issues/721'>INU-721</a> token by contract address.",
    required_params: [
      %{
        key: "contractaddress",
        placeholder: "contractAddressHash",
  ...
  @stats_tokensupply_action %{
    name: "tokensupply",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>INU-20</a> or " <>
        "<a href='https://github.com/ethereum/EIPs/issues/721'>INU-721</a> " <>
